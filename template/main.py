import dataset
from model import LeNet5, CustomMLP, RegularizedLenet5
import torch
...
def visualization(trn_loss_avg, trn_acc_avg, tst_loss_avg, tst_acc_avg):
    ...
    axes[0, 0].plot(trn_loss_avg[1], label='regularized LeNet-5', c='g')
    ...
    axes[0, 1].plot(trn_acc_avg[1], label='regularized LeNet-5', c='g')
    ...
    axes[1, 0].plot(tst_loss_avg[1], label='regularized LeNet-5', c='g')
    ...
    axes[1, 1].plot(tst_acc_avg[1], label='regularized LeNet-5', c='g')
...
def main():
    ...
    """
    # 3)
    regularized_lenet_model = RegularizedLenet5().to(device)
